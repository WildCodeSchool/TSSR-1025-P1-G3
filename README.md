...
| GEOGES      | SM         | Installer KeePass, configurer la base de données et la chiffrer sous Windows Server, commencer la documentation   |
...
| GEOGES      | Technicien | Créer des mots de passe et des utilisateurs sur le serveur Windows, les chiffrer et permettre l’accès des clients à la base de données |
